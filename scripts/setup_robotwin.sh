...
echo "Browser studio: ./lab --backend robo_twin --model $example_model --mode interactive --task-id click_bell --default"
echo "Native batch: ./lab --backend robo_twin --model $example_model --mode batch --task-id click_bell --default"
