...
<p align="center">
  <img src="docs/assets/flexpi-world-action-comparison.gif"
       alt="Actual LIBERO execution beside the future generated by Flex-pi"
       width="960">
</p>

<p align="center"><sub>
Flex-π full-joint mode: an action-aligned generated future beside the completed
LIBERO execution. The comparison is revealed after execution and is diagnostic;
it does not gate or select the action.
</sub></p>
...
<p align="center">
  <img src="docs/assets/flexpi-dashboard.webp"
       alt="Embodied Policy Lab post-rollout Flex-pi world-action comparison panel"
       width="1100">
</p>
